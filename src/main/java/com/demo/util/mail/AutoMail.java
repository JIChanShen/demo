package com.demo.util.mail;

import com.demo.util.base.ReadProperties;
...
public class AutoMail {
	public static void main(String[] args) throws AddressException, FileNotFoundException, IOException {
		...
		String logostr="<h1 style=\"color:red ; font-size:50px;font-family: '楷体','楷体_GB2312';\">demoProject</h1><h1>自动化测试报告</h1>";
